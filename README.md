...
**PDF:** run `typst compile --root . print/swatches.typ` to regenerate, or use the [Tinymist](https://marketplace.visualstudio.com/items?itemName=myriad-dreamin.tinymist) VS Code extension.
